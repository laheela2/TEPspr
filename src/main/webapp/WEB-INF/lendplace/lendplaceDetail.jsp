 			...
 			<section>
				...
				<div class="col-sm-4">
					...
					<p>
						...
						<button type="submit" class="btn btn-template-main" onclick="fn_lendplaceApplyfor()"><i class="fa fa-check"></i> 장소신청</button>
					</p>
				</div>
        ...
        <section>
            <div class="row portfolio">
                ...
                <div class="col-md-12">
					...
					<p>* TEP에서 소규모의 미팅이나 스터디, 세미나 그리고 대규모의 강연까지 가능한 모임장소를 추천해 드립니다.<br>
					* 모임의 목적에 맞는 규모와 장소, 시간, 편의시설, 지원장비 등을 꼼꼼히 확인하시고 목록에서 장소를 신청해 주세요.<br></p>                    
                </div>
