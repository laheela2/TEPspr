			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="portfolio-showcase clearfix">
						...
						<div class="col-sm-6">
							<h3>
								<a href="portfolio-detail.html">Portfolio item</a>
							</h3>
				...
				<div class="row portfolio no-space">
					<div class="col-sm-4">
						<div class="box-image">
							...
							<div class="name">
								<h3>
									<a href="portfolio-detail.html">Portfolio box-image</a>
								</h3>
							</div>
							<div class="text">
		...
		<div class="row showcase">
			...
			<div class="col-md-3 col-sm-6">
				<div class="item">
					...
					<h4>
						<span class="counter">923</span><br> Magazines and Brochures
					</h4>
				</div>
			</div>
		</div>
...
<section class="bar background-white no-mb">
	<div class="container">
		...
		<div class="col-md-12">
			...
			<p class="lead">
				Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo. <span class="accent">Check our blog!</span>
			</p>
				...
				<div class="col-md-3 col-sm-6">
					<div class="box-image-text blog">
						<div class="top">
							...
							<div class="text">
								<p class="buttons">
									<a href="blog-post.html" class="btn btn-template-transparent-primary">
						...
						<div class="content">
							...
							<p class="read-more">
								<a href="blog-post.html" class="btn btn-template-main">Continue reading</a>
							</p>
						</div>
					</div>
					<!-- /.box-image-text -->
		...
		<div class="row">
			<div class="col-md-12">
				<ul class="owl-carousel customers">
					<li class="item"><img src="img/customer-1.png" alt="" class="img-responsive"></li>
					<li class="item"><img src="img/customer-2.png" alt="" class="img-responsive"></li>
					<li class="item"><img src="img/customer-3.png" alt="" class="img-responsive"></li>
					<li class="item"><img src="img/customer-4.png" alt="" class="img-responsive"></li>
					<li class="item"><img src="img/customer-5.png" alt="" class="img-responsive"></li>
					<li class="item"><img src="img/customer-6.png" alt="" class="img-responsive"></li>
				</ul>
				<!-- /.owl-carousel -->
			</div>
